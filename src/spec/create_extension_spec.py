    ...
    microphone_table = NWBGroupSpec(
        ...
        datasets=[
            ...
            NWBDatasetSpec(
                ...
                dtype=NWBRefSpec(target_type='Microphone', reftype="object"),
                shape=(None,),
                neurodata_type_inc="VectorData",
            ),
            NWBDatasetSpec(
                name="audio_interface_device",
                doc="Link to audio interface device object.",
                dtype=NWBRefSpec(target_type='AudioInterfaceDevice', reftype="object"),
                shape=(None,),
                neurodata_type_inc="VectorData",
            ),
        ],
    ...
    speaker_table = NWBGroupSpec(
        ...
        datasets=[
            ...
            NWBDatasetSpec(
                ...
                dtype=NWBRefSpec(target_type='Speaker', reftype="object"),
                shape=(None,),
                neurodata_type_inc="VectorData",
            ),
            NWBDatasetSpec(
